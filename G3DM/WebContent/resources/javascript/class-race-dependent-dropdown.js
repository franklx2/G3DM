...
$("#categories").change(function() {
				...
				function leftlist(array_list)
				{
					$("#subcats-left").html(""); //reset child options
					$(array_list).each(function (i) { //populate child options
					$("#subcats-left").append("<option value=\""+array_list[i].value+"\">"+array_list[i].display+"</option>");
					});
					
					
				}
				function rightlist(array_list)
				{
					$("#subcats-right").html(""); //reset child options
					$(array_list).each(function (i) { //populate child options
					$("#subcats-right").append("<option value=\""+array_list[i].value+"\">"+array_list[i].display+"</option>");
					});
